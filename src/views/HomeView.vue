<template>
  <ytd-app darker-dark-theme="" guide-persistent-and-visible="">
    ...
    <ytd-miniplayer
      ...
      <div id="blocking-container" class="style-scope ytd-miniplayer" hidden="">
        <yt-icon-button class="style-scope ytd-miniplayer" aria-label="Close player"
          ><!--css-build:shady--><!--css-build:shady--><button
            id="button"
            class="style-scope yt-icon-button"
          >
            <yt-icon id="close-icon" icon="yt-icons:close" class="style-scope ytd-miniplayer"
      ...
      <div class="miniplayer style-scope ytd-miniplayer" role="dialog">
        <div id="card" class="style-scope ytd-miniplayer">
          <div id="video-container" class="style-scope ytd-miniplayer" style="touch-action: pan-x">
              ...
              <div class="metadata style-scope ytd-miniplayer">
                <h1 class="title meta style-scope ytd-miniplayer" role="heading" hidden="">
                  <a tabindex="0" class="style-scope ytd-miniplayer">
                    <yt-formatted-string
                      class="miniplayer-title style-scope ytd-miniplayer"
                      ellipsis-truncate=""
                      is-empty=""
                ...
                <div class="channel style-scope ytd-miniplayer">
                  <ytd-badge-supported-renderer
                    id="premium-badges"
                    class="style-scope ytd-miniplayer"
                    disable-upgrade=""
                    hidden=""
                  >
                  </ytd-badge-supported-renderer>
                  <yt-formatted-string
                    ...
                    ></yt-attributed-string
                  ></yt-formatted-string>
                  <div class="index-message style-scope ytd-miniplayer" hidden="">
                    <span class="text-divider style-scope ytd-miniplayer">•</span>
                    <span class="style-scope ytd-miniplayer"></span>
                  </div>
                </div>
              </div>
              <div class="expander style-scope ytd-miniplayer" hidden="">
                <yt-icon-button class="style-scope ytd-miniplayer"
                  ><!--css-build:shady--><!--css-build:shady--><button
                    ...
                    aria-label="Expand"
                  >
                    <yt-icon class="style-scope ytd-miniplayer"
                      ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                        class="style-scope yt-icon"
                        ><icon-shape class="yt-spec-icon-shape">
                          <div style="width: 100%; height: 100%; fill: currentcolor">
            ...
            <div id="container" class="style-scope ytd-playlist-panel-renderer">
              <div class="header style-scope ytd-playlist-panel-renderer">
                <div id="header-contents" class="style-scope ytd-playlist-panel-renderer">
                  <div id="header-top-row" class="style-scope ytd-playlist-panel-renderer">
                    <div id="header-description" class="style-scope ytd-playlist-panel-renderer">
                      <h3 class="style-scope ytd-playlist-panel-renderer">
                        <yt-formatted-string
                          class="title style-scope ytd-playlist-panel-renderer"
                          ellipsis-truncate=""
                          link-inherit-color=""
                          is-empty=""
                          ellipsis-truncate-styling=""
                      ...
                      <h3
                        ...
                        hidden=""
                      >
                        <span id="next-label" class="style-scope ytd-playlist-panel-renderer"></span
                        ><yt-formatted-string
                          ellipsis-truncate=""
                          class="style-scope ytd-playlist-panel-renderer"
                          is-empty=""
                      ...
                      <div id="publisher-container" class="style-scope ytd-playlist-panel-renderer">
                        <yt-formatted-string
                          class="byline-title style-scope ytd-playlist-panel-renderer"
                          ellipsis-truncate=""
                          hidden=""
                          is-empty=""
                          ellipsis-truncate-styling=""
                        ...
                        ></ytd-badge-supported-renderer
                        ><yt-formatted-string
                          class="publisher style-scope ytd-playlist-panel-renderer"
                          ellipsis-truncate=""
                          link-inherit-color=""
                          is-empty=""
                          ellipsis-truncate-styling=""
                          ...
                          ></yt-attributed-string
                        ></yt-formatted-string>
                        <div class="index-message-wrapper style-scope ytd-playlist-panel-renderer">
                          <span class="index-message style-scope ytd-playlist-panel-renderer"
                            >NaN / NaN</span
                          ><yt-formatted-string
                            class="index-message style-scope ytd-playlist-panel-renderer"
                            respecthtmldir=""
                            hidden=""
                            is-empty=""
                            ><!--css-build:shady--><!--css-build:shady--><yt-attributed-string
                    ...
                    <div id="top-row-buttons" class="style-scope ytd-playlist-panel-renderer"></div>
                    <yt-icon-button
                      id="expand-button"
                      toggleable=""
                      class="style-scope ytd-playlist-panel-renderer"
                      ><!--css-build:shady--><!--css-build:shady--><button
                        ...
                        aria-label="Expand"
                      >
                        <yt-icon id="expand-icon" class="style-scope ytd-playlist-panel-renderer"
                          ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                            class="style-scope yt-icon"
                            ><icon-shape class="yt-spec-icon-shape">
                              <div style="width: 100%; height: 100%; fill: currentcolor">
                  ...
                  <div id="playlist-actions" class="style-scope ytd-playlist-panel-renderer">
                    <div id="start-actions" class="style-scope ytd-playlist-panel-renderer">
                      <div
                        id="playlist-action-menu"
                        class="style-scope ytd-playlist-panel-renderer"
                      ></div>
                      <div id="save-button" class="style-scope ytd-playlist-panel-renderer"></div>
                    </div>
                    <div id="end-actions" class="style-scope ytd-playlist-panel-renderer">
                      <div id="overflow-menu" class="style-scope ytd-playlist-panel-renderer"></div>
                    </div>
                  </div>
                </div>
              </div>
              <div
                ...
                hidden=""
              ></div>
              <div id="items" class="playlist-items style-scope ytd-playlist-panel-renderer"></div>
            </div>
          </ytd-playlist-panel-renderer>
          <div id="expander-space" class="style-scope ytd-miniplayer"></div>
          <ytd-miniplayer-toast id="toast" class="style-scope ytd-miniplayer"
            ><!--css-build:shady--><!--css-build:shady--><ytd-thumbnail
              width="78"
              class="style-scope ytd-miniplayer-toast"
              size="small"
              ><!--css-build:shady--><!--css-build:shady--><a
                id="thumbnail"
    ...
    <div id="content" class="style-scope ytd-app">
      <div id="masthead-container" class="style-scope ytd-app">
        <ytd-masthead
          id="masthead"
          logo-type="YOUTUBE_LOGO"
          slot="masthead"
          class="masthead-finish"
          darker-dark-theme=""
          role="banner"
          guide-persistent-and-visible=""
          ><!--css-build:shady--><!--css-build:shady--><iron-media-query
          ...
          <div id="container" class="style-scope ytd-masthead">
            <div id="start" class="style-scope ytd-masthead">
              <yt-icon-button id="back-button" class="style-scope ytd-masthead"
                ><!--css-build:shady--><!--css-build:shady--><button
                  id="button"
                  class="style-scope yt-icon-button"
                  aria-label="Back"
              ...
              <ytd-topbar-logo-renderer id="logo" class="style-scope ytd-masthead"
                ><!--css-build:shady--><!--css-build:shady--><a
                ...
                >
                  <div class="style-scope ytd-topbar-logo-renderer">
                    <ytd-logo class="style-scope ytd-topbar-logo-renderer"
                      ><!--css-build:shady--><!--css-build:shady--><yt-icon
                        ...
                        ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                          ...
                          ><icon-shape class="yt-spec-icon-shape">
                            ...
                            </div> </icon-shape></yt-icon-shape></yt-icon
                    ></ytd-logo>
                  </div>
                  <ytd-yoodle-renderer class="style-scope ytd-topbar-logo-renderer" hidden=""
                    ...
                    <ytd-logo class="style-scope ytd-yoodle-renderer" hidden=""
                      ><!--css-build:shady--><!--css-build:shady--><yt-icon
                        id="logo-icon"
                        class="style-scope ytd-logo"
                        ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                    ...
                    ></ytd-logo>
                    <ytd-lottie-player
                      class="style-scope ytd-yoodle-renderer"
                      hidden=""
                    ></ytd-lottie-player>
                  </ytd-yoodle-renderer>
                </a>
                <span id="country-code" class="style-scope ytd-topbar-logo-renderer"> VN </span>
            ...
            <div id="center" class="style-scope ytd-masthead">
              <ytd-searchbox
                ...
                <form id="search-form" action="/results" class="style-scope ytd-searchbox">
                  <div id="container" class="style-scope ytd-searchbox">
                    ...
                    <div id="search-clear-button" class="style-scope ytd-searchbox" hidden="">
                      <ytd-button-renderer
              ...
              <yt-icon-button id="search-button-narrow" class="style-scope ytd-masthead"
                ><!--css-build:shady--><!--css-build:shady--><button
                  id="button"
                  class="style-scope yt-icon-button"
                  aria-label="Search"
                >
                  <yt-icon
                    class="topbar-icons style-scope ytd-masthead"
              ...
              <div id="voice-search-button" class="style-scope ytd-masthead">
                <ytd-button-renderer
                  ...
                  ><tp-yt-paper-tooltip
                    ...
                    role="tooltip"
                    tabindex="-1"
                    style="inset: 56px auto auto 1166.77px"
                    ><!--css-build:shady-->
                    <div
                      id="tooltip"
                      class="style-scope tp-yt-paper-tooltip hidden"
            ...
            <div id="end" class="style-scope ytd-masthead">
              ...
              <div id="buttons" class="style-scope ytd-masthead">
                <ytd-topbar-menu-button-renderer
                  ...
                  is-icon-button=""
                  has-no-text=""
                  ><!--css-build:shady--><!--css-build:shady--><dom-if
                  ...
                  <div id="button" class="style-scope ytd-topbar-menu-button-renderer">
                    <a
                      ...
                      ><tp-yt-paper-tooltip
                        ...
                        role="tooltip"
                        tabindex="-1"
                        style="inset: 56px auto auto 1108.54px"
                        ><!--css-build:shady-->
                        <div
                          id="tooltip"
                          class="style-scope tp-yt-paper-tooltip hidden"
                      ...
                      </tp-yt-paper-tooltip></a
                    >
                  </div> </ytd-topbar-menu-button-renderer
                ><ytd-notification-topbar-button-renderer class="style-scope ytd-masthead"
                  ><!--css-build:shady--><!--css-build:shady--><yt-icon-button
                    id="icon"
                    class="style-scope ytd-notification-topbar-button-renderer"
                    ><!--css-build:shady--><!--css-build:shady--><button
                      id="button"
                      class="style-scope yt-icon-button"
                    ...
                    >
                      ...
                      >
                        <div
                          class="yt-spec-icon-badge-shape yt-spec-icon-badge-shape--type-notification"
                        >
                          <div class="yt-spec-icon-badge-shape__icon">
                            <yt-icon
                              ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                                class="style-scope yt-icon"
                                ><icon-shape class="yt-spec-icon-shape">
                          ...
                          <div class="yt-spec-icon-badge-shape__badge">1</div>
                        </div>
                      </yt-icon-badge-shape></button
                    ><yt-interaction id="interaction" class="circular style-scope yt-icon-button"
                      ><!--css-build:shady--><!--css-build:shady-->
                      <div class="stroke style-scope yt-interaction"></div>
                      <div class="fill style-scope yt-interaction"></div> </yt-interaction
                  ...
                  </tp-yt-paper-tooltip> </ytd-notification-topbar-button-renderer
                ><ytd-topbar-menu-button-renderer
                  class="style-scope ytd-masthead"
                  use-keyboard-focused=""
                  ><!--css-build:shady--><!--css-build:shady-->
                  ...
                  >
                    <yt-img-shadow
                      ...
                      ><!--css-build:shady--><!--css-build:shady--><img
                        ...
                        height="32"
                        width="32"
                        src="https://yt3.ggpht.com/yti/AOXPAcW_IDWMBctMB_b81dEAy5iJI_4w9azDVupFFQ=s88-c-k-c0x00ffffff-no-rj"
                    /></yt-img-shadow>
                  </button>
      ...
      <tp-yt-app-drawer
        ...
        role="navigation"
        class="style-scope ytd-app"
        style="transition-duration: 0ms; touch-action: pan-y"
        position="left"
        swipe-open=""
        opened=""
        persistent=""
        ><!--css-build:shady-->
        <div id="scrim" class="style-scope tp-yt-app-drawer" style="transition-duration: 0ms"></div>

        <div
          id="contentContainer"
          class="style-scope tp-yt-app-drawer"
        ...
        >
          <div id="guide-wrapper" class="style-scope ytd-app">
            ...
            <div id="guide-content" class="style-scope ytd-app">
              <div id="header" class="style-scope ytd-app" hidden="">
                <yt-icon-button
                  id="guide-button"
                  pressed="true"
                  toggleable="true"
                  ...
                  ><yt-interaction id="interaction" class="circular style-scope yt-icon-button"
                    ...
                    <div class="fill style-scope yt-interaction"></div> </yt-interaction
                ></yt-icon-button>
                <ytd-topbar-logo-renderer class="style-scope ytd-app"
                  ><!--css-build:shady--><!--css-build:shady--><a
                    class="yt-simple-endpoint style-scope ytd-topbar-logo-renderer"
                    id="logo"
                    aria-label=""
              ...
              <div id="guide-inner-content" class="style-scope ytd-app">
                <ytd-guide-renderer id="guide-renderer" class="style-scope ytd-app"
                  ...
                  <div id="sections" class="style-scope ytd-guide-renderer">
                    <ytd-guide-section-renderer
                      class="style-scope ytd-guide-renderer"
                      guide-persistent-and-visible=""
                      ><!--css-build:shady--><!--css-build:shady-->
                      <h3 class="style-scope ytd-guide-section-renderer" hidden="">
                        <yt-formatted-string
                      ...
                      <div id="items" class="style-scope ytd-guide-section-renderer">
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                ...
                                >Home</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                                size="16"
                                disable-upgrade=""
                                hidden=""
                              ...
                              <yt-icon
                                class="guide-entry-badge style-scope ytd-guide-entry-renderer"
                                size="16"
                                disable-upgrade=""
                              >
                              </yt-icon>
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >Subscriptions</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-collapsible-section-entry-renderer
                          ...
                          <div
                            id="header"
                            class="style-scope ytd-guide-collapsible-section-entry-renderer"
                          >
                            <ytd-guide-entry-renderer
                              id="header-entry"
                              class="style-scope ytd-guide-collapsible-section-entry-renderer"
                              ...
                              >
                                <tp-yt-paper-item
                                  ...
                                  <span
                                    class="guide-entry-count style-scope ytd-guide-entry-renderer"
                                  >
                                  </span>
                                  <yt-icon
                                    class="guide-entry-badge style-scope ytd-guide-entry-renderer"
                          ...
                          >
                            ...
                            ><ytd-guide-entry-renderer
                              ...
                              ><!--css-build:shady--><!--css-build:shady--><a
                                ...
                                role=""
                                title="Your videos"
                                href="https://studio.youtube.com/channel/UCZHyg92Fu_7KQIwGS3A0_2w/videos"
                              >
                                <tp-yt-paper-item
                                  class="style-scope ytd-guide-entry-renderer"
                                  role="link"
                                  ...
                                  <yt-formatted-string
                                    class="title style-scope ytd-guide-entry-renderer"
                                    >Your videos</yt-formatted-string
                                  >
                                  <yt-icon
                                    class="arrow-icon style-scope ytd-guide-entry-renderer"
                                    icon="chevron_right"
                            ...
                            ><ytd-guide-entry-renderer
                              ...
                              >
                                <tp-yt-paper-item
                                  ...
                                  <yt-formatted-string
                                    class="title style-scope ytd-guide-entry-renderer"
                                    >Watch later</yt-formatted-string
                                  >
                                  <yt-icon
                                    class="arrow-icon style-scope ytd-guide-entry-renderer"
                                    icon="chevron_right"
                            ...
                            ><ytd-guide-downloads-entry-renderer
                              ...
                              <ytd-guide-entry-renderer
                                id="downloads-entry"
                                class="style-scope ytd-guide-downloads-entry-renderer"
                                hidden=""
                                is-primary=""
                                line-end-style="none"
                                ><!--css-build:shady--><!--css-build:shady--><a
                              ...
                              </ytd-guide-entry-renderer> </ytd-guide-downloads-entry-renderer
                            ><ytd-guide-entry-renderer
                              class="style-scope ytd-guide-collapsible-section-entry-renderer"
                              line-end-style="none"
                              ><!--css-build:shady--><!--css-build:shady--><a
                                ...
                                role=""
                                title="Nhạc Việt mới"
                                href="/playlist?list=PLa95TXKN_969sbj_Rg7Fi8QqeQm3xcl7l"
                              >
                                <tp-yt-paper-item
                                  class="style-scope ytd-guide-entry-renderer"
                                  role="link"
                                  ...
                                  <yt-formatted-string
                                    class="title style-scope ytd-guide-entry-renderer"
                                    >Nhạc Việt mới</yt-formatted-string
                                  >
                                  <yt-icon
                                    class="arrow-icon style-scope ytd-guide-entry-renderer"
                                    icon="chevron_right"
                            ...
                            ><ytd-guide-collapsible-entry-renderer
                              class="style-scope ytd-guide-collapsible-section-entry-renderer"
                              can-show-more=""
                              ><!--css-build:shady--><!--css-build:shady--><ytd-guide-entry-renderer
                                id="expander-item"
                                ...
                                <ytd-guide-entry-renderer
                                  ...
                                  >
                                    <tp-yt-paper-item
                                      ...
                                      ><!--css-build:shady-->
                                      <yt-icon
                                        class="guide-icon style-scope ytd-guide-entry-renderer"
                                        ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                                          class="style-scope yt-icon"
                                          ><icon-shape class="yt-spec-icon-shape">
                                            <div
                        ...
                        <ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-label="Phê Game. New content available."
                              ><!--css-build:shady-->
                              <yt-icon
                                class="guide-icon style-scope ytd-guide-entry-renderer"
                                disable-upgrade='{"thumbnails":[{"url":"https://yt3.ggpht.com/dvkwpq535yU2dsHTTDg85NsrdA-WUr-Fc--3FTmmlc8isGRgcVmEZ215u9dqE1mvtDwIuxhL=s88-c-k-c0x00ffffff-no-rj"}]}'
                                hidden=""
                              >
                              </yt-icon>
                              <yt-img-shadow
                                ...
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  ...
                                  width="24"
                                  alt=""
                                  src="https://yt3.ggpht.com/dvkwpq535yU2dsHTTDg85NsrdA-WUr-Fc--3FTmmlc8isGRgcVmEZ215u9dqE1mvtDwIuxhL=s88-c-k-c0x00ffffff-no-rj"
                              /></yt-img-shadow>
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >Phê Game</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-label="Phê Phim. New content available."
                              ><!--css-build:shady-->
                              <yt-icon
                                class="guide-icon style-scope ytd-guide-entry-renderer"
                                disable-upgrade='{"thumbnails":[{"url":"https://yt3.ggpht.com/ytc/AOPolaSLLWra5KIwA4xVQdVf8JN1BsUpoKSXN0JIb6AvQQ=s88-c-k-c0x00ffffff-no-rj"}]}'
                                hidden=""
                              >
                              </yt-icon>
                              <yt-img-shadow
                                ...
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  ...
                                  width="24"
                                  alt=""
                                  src="https://yt3.ggpht.com/ytc/AOPolaSLLWra5KIwA4xVQdVf8JN1BsUpoKSXN0JIb6AvQQ=s88-c-k-c0x00ffffff-no-rj"
                              /></yt-img-shadow>
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >Phê Phim</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-label="W2W Movie. New content available."
                              ><!--css-build:shady-->
                              <yt-icon
                                class="guide-icon style-scope ytd-guide-entry-renderer"
                                disable-upgrade='{"thumbnails":[{"url":"https://yt3.ggpht.com/G5AYnCYm40VpnXeTFHafqJcThLgwWjoM98I7IFBkoJaFm3ObhvLCilemOquYh7nDtmB9p3TLayQ=s88-c-k-c0x00ffffff-no-rj"}]}'
                                hidden=""
                              >
                              </yt-icon>
                              <yt-img-shadow
                                ...
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  ...
                                  width="24"
                                  alt=""
                                  src="https://yt3.ggpht.com/G5AYnCYm40VpnXeTFHafqJcThLgwWjoM98I7IFBkoJaFm3ObhvLCilemOquYh7nDtmB9p3TLayQ=s88-c-k-c0x00ffffff-no-rj"
                              /></yt-img-shadow>
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >W2W Movie</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-label="The Reviewer. New content available."
                              ><!--css-build:shady-->
                              <yt-icon
                                class="guide-icon style-scope ytd-guide-entry-renderer"
                                disable-upgrade='{"thumbnails":[{"url":"https://yt3.ggpht.com/kj7Bo1BChCXP4FdC9X8nR2Zwp6yU6SEXZYC0WbEqdwV6Ff_OSeXUsj6k0crXz1FYG7ZKWyeQ2w=s88-c-k-c0x00ffffff-no-rj"}]}'
                                hidden=""
                              >
                              </yt-icon>
                              <yt-img-shadow
                                ...
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  ...
                                  width="24"
                                  alt=""
                                  src="https://yt3.ggpht.com/kj7Bo1BChCXP4FdC9X8nR2Zwp6yU6SEXZYC0WbEqdwV6Ff_OSeXUsj6k0crXz1FYG7ZKWyeQ2w=s88-c-k-c0x00ffffff-no-rj"
                              /></yt-img-shadow>
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >The Reviewer</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-label="PKD. New content available."
                              ><!--css-build:shady-->
                              <yt-icon
                                class="guide-icon style-scope ytd-guide-entry-renderer"
                                disable-upgrade='{"thumbnails":[{"url":"https://yt3.ggpht.com/gFAnLkE0EJGMrGVvaIl-iKvOJzNXni6SFAD02mQNutWMvHWlXrHm3_ZXTqnlTbTRMUUSgg0QAg=s88-c-k-c0x00ffffff-no-rj"}]}'
                                hidden=""
                              >
                              </yt-icon>
                              <yt-img-shadow
                                ...
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  ...
                                  width="24"
                                  alt=""
                                  src="https://yt3.ggpht.com/gFAnLkE0EJGMrGVvaIl-iKvOJzNXni6SFAD02mQNutWMvHWlXrHm3_ZXTqnlTbTRMUUSgg0QAg=s88-c-k-c0x00ffffff-no-rj"
                              /></yt-img-shadow>
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >PKD</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-label="Vui Vẻ. New content available."
                              ><!--css-build:shady-->
                              <yt-icon
                                class="guide-icon style-scope ytd-guide-entry-renderer"
                                disable-upgrade='{"thumbnails":[{"url":"https://yt3.ggpht.com/QbgyZtZOUqg0JUQwTgMYihTRWUb_Lesp2LUTlhuMmzYJh80RBA8nU2sm082847nvB31Bsl7jBg=s88-c-k-c0x00ffffff-no-rj"}]}'
                                hidden=""
                              >
                              </yt-icon>
                              <yt-img-shadow
                                ...
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  ...
                                  width="24"
                                  alt=""
                                  src="https://yt3.ggpht.com/QbgyZtZOUqg0JUQwTgMYihTRWUb_Lesp2LUTlhuMmzYJh80RBA8nU2sm082847nvB31Bsl7jBg=s88-c-k-c0x00ffffff-no-rj"
                              /></yt-img-shadow>
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >Vui Vẻ</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-icon
                                class="guide-icon style-scope ytd-guide-entry-renderer"
                                disable-upgrade='{"thumbnails":[{"url":"https://yt3.ggpht.com/ytc/AOPolaRRPp4HOOjIm4kSrMgW71ejXoFDn2wDTCItORykFA=s88-c-k-c0x00ffffff-no-rj"}]}'
                                hidden=""
                              >
                              </yt-icon>
                              <yt-img-shadow
                                ...
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  ...
                                  width="24"
                                  alt=""
                                  src="https://yt3.ggpht.com/ytc/AOPolaRRPp4HOOjIm4kSrMgW71ejXoFDn2wDTCItORykFA=s88-c-k-c0x00ffffff-no-rj"
                              /></yt-img-shadow>
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >Hi im Coconut</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                          ...
                          ><!--css-build:shady--><!--css-build:shady--><ytd-guide-entry-renderer
                            ...
                            >
                              <tp-yt-paper-item
                                ...
                                <yt-formatted-string
                                  class="title style-scope ytd-guide-entry-renderer"
                                  >Show 180 more</yt-formatted-string
                                >
                                <yt-icon
                                  class="arrow-icon style-scope ytd-guide-entry-renderer"
                                  icon="chevron_right"
                      ...
                      <div id="items" class="style-scope ytd-guide-section-renderer">
                        <ytd-guide-entry-renderer
                          ...
                          ><!--css-build:shady--><!--css-build:shady--><a
                            ...
                            role=""
                            title="Trending"
                            href="/feed/trending?bp=6gQJRkVleHBsb3Jl"
                          >
                            <tp-yt-paper-item
                              class="style-scope ytd-guide-entry-renderer"
                              role="link"
                    ...
                    ><ytd-guide-section-renderer
                      ...
                      <h3 class="style-scope ytd-guide-section-renderer">
                        <yt-formatted-string
                          ...
                          link-inherit-color=""
                          class="style-scope ytd-guide-section-renderer"
                          >More from YouTube</yt-formatted-string
                        >
                      </h3>
                      <div id="items" class="style-scope ytd-guide-section-renderer">
                        <ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >YouTube Premium</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >YouTube Studio</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >YouTube Music</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >YouTube Kids</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >Report history</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                        ...
                        ><ytd-guide-entry-renderer
                          ...
                          >
                            <tp-yt-paper-item
                              ...
                              <yt-formatted-string
                                class="title style-scope ytd-guide-entry-renderer"
                                >Send feedback</yt-formatted-string
                              >
                              <yt-icon
                                class="arrow-icon style-scope ytd-guide-entry-renderer"
                                icon="chevron_right"
                  ...
                  <div id="footer" class="style-scope ytd-guide-renderer">
                    <div id="guide-links-primary" class="style-scope ytd-guide-renderer">
                      ...
                      ><a
                        ...
                        style="display: none"
                        >Copyright</a
                      ><a slot="guide-links-primary" href="/t/contact_us/" style="display: none"
                        >Contact us</a
                      ><a
                        slot="guide-links-primary"
                    ...
                    <div id="guide-links-secondary" class="style-scope ytd-guide-renderer">
                      ...
                      ><a slot="guide-links-secondary" href="/t/privacy" style="display: none"
                        >Privacy</a
                      ><a
                      ...
                      ><a
                        ...
                        style="display: none"
                        >How YouTube works</a
                      ><a slot="guide-links-secondary" href="/new" style="display: none"
                        >Test new features</a
                      >
                    </div>
                ...
                <dom-if class="style-scope ytd-app"><template is="dom-if"></template></dom-if>
              </div>
            </div>
          </div>
        </div>
      ...
      <ytd-mini-guide-renderer
        ...
        disable-upgrade=""
        ><!--css-build:shady--><!--css-build:shady-->
        <div id="items" class="style-scope ytd-mini-guide-renderer">
          ...
          ><ytd-mini-guide-entry-renderer
            ...
            >
              ...
              ></yt-icon>
              <span class="title style-scope ytd-mini-guide-entry-renderer">Library</span>
              <tp-yt-paper-tooltip
                animation-delay="0"
                offset="4"
                position="right"
      ...
      <ytd-page-manager id="page-manager" class="style-scope ytd-app"
        ><!--css-build:shady--><!--css-build:shady--><ytd-browse
          class="style-scope ytd-page-manager"
          rounded-container=""
          darker-dark-theme=""
          page-subtype="home"
          rich-grid-watch-status="inactive"
          role="main"
          amsterdam=""
          has-sidebar=""
          guide-persistent-and-visible=""
          ...
          <ytd-playlist-header-renderer class="style-scope ytd-browse" disable-upgrade="" hidden="">
              ...
              <ytd-rich-grid-renderer
                ...
                <div id="header" class="style-scope ytd-rich-grid-renderer">
                  <ytd-feed-filter-chip-bar-renderer
                    ...
                    style="
                      --ytd-rich-grid-chips-bar-width: 1609px;
                      ...
                      >
                        ...
                        >
                          <yt-chip-cloud-chip-renderer
                            ...
                            selected=""
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              id="text"
                              ellipsis-truncate=""
                              class="style-scope yt-chip-cloud-chip-renderer"
                              ellipsis-truncate-styling=""
                              title="All"
                              >All</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                          ...
                          ><yt-chip-cloud-chip-renderer
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              ellipsis-truncate-styling=""
                              title="Youth music"
                              >Youth music</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              >Pokémon Scarlet and Violet</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              ellipsis-truncate-styling=""
                              title="Superheroes"
                              >Superheroes</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                          ...
                          ><yt-chip-cloud-chip-renderer
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              >Role-Playing Games</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                          ...
                          ><yt-chip-cloud-chip-renderer
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              ellipsis-truncate-styling=""
                              title="Asian music"
                              >Asian music</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              >Consumer Electronics</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              >Recently uploaded</yt-formatted-string
                            > </yt-chip-cloud-chip-renderer
                          ><yt-chip-cloud-chip-renderer
                            class="style-scope ytd-feed-filter-chip-bar-renderer"
                            aria-selected="false"
                          ...
                          ><yt-chip-cloud-chip-renderer
                            ...
                            ><!--css-build:shady--><!--css-build:shady--><yt-formatted-string
                              ...
                              ellipsis-truncate-styling=""
                              title="New to you"
                              >New to you</yt-formatted-string
                            >
                          </yt-chip-cloud-chip-renderer></iron-selector
                        >
                      </div>
                ...
                <div id="masthead-ad" class="style-scope ytd-rich-grid-renderer">
                  <ytd-banner-promo-renderer
                    class="style-scope ytd-rich-grid-renderer"
                    button-update=""
                    style="
                      --yt-basic-background-color: rgba(255, 255, 255, 1);
                      --yt-basic-foreground-body-color: rgba(24, 24, 24, 1);
                      --yt-basic-foreground-activated-color: rgba(24, 24, 24, 1);
                    "
                    guide-persistent-and-visible=""
                    ><!--css-build:shady--><!--css-build:shady-->
                    <div
                      class="ytd-banner-promo-renderer-background style-scope ytd-banner-promo-renderer"
                    >
                      <ytd-button-renderer
                        id="dismiss-button"
                        class="style-scope ytd-banner-promo-renderer"
                        button-renderer=""
                        button-next=""
                        ><!--css-build:shady--><yt-button-shape
                          ><button
                            class="yt-spec-button-shape-next yt-spec-button-shape-next--tonal yt-spec-button-shape-next--overlay-dark yt-spec-button-shape-next--size-m yt-spec-button-shape-next--icon-button"
                            aria-label="Close"
                            style=""
                          >
                            <div class="yt-spec-button-shape-next__icon" aria-hidden="true">
                            ...
                            <yt-touch-feedback-shape style="border-radius: inherit">
                              <div
                                class="yt-spec-touch-feedback-shape yt-spec-touch-feedback-shape--overlay-touch-response-inverse"
                                aria-hidden="true"
                              >
                                <div class="yt-spec-touch-feedback-shape__stroke" style=""></div>
                                <div class="yt-spec-touch-feedback-shape__fill" style=""></div>
                      ...
                      ></ytd-button-renderer>
                      <div
                        class="ytd-banner-promo-renderer-layout-container style-scope ytd-banner-promo-renderer"
                      >
                        <div
                          class="ytd-banner-promo-renderer-layout style-scope ytd-banner-promo-renderer"
                        >
                          <img
                            alt=""
                            class="ytd-banner-promo-renderer-inline-image style-scope ytd-banner-promo-renderer"
                            src="https://www.gstatic.com/youtube/img/promos/growth/3e5a02221ef0984521f64b2c3c664064a5067aecc3ec8de1c89319ae47193d91_2560x520.jpeg"
                          />

                          <h1
                            class="ytd-banner-promo-renderer-logo style-scope ytd-banner-promo-renderer"
                          >
                            <yt-img-shadow
                              height="24"
                              class="style-scope ytd-banner-promo-renderer no-transition empty"
                              style="background-color: transparent"
                              ><!--css-build:shady--><!--css-build:shady--><img
                                id="img"
                                draggable="false"
                          ...
                          <dom-if class="style-scope ytd-banner-promo-renderer"
                            ><template is="dom-if"></template
                          ></dom-if>
                          <div
                            class="ytd-banner-promo-renderer-content style-scope ytd-banner-promo-renderer"
                          >
                            <div
                              class="dynamic-text-container style-scope ytd-banner-promo-renderer"
                            >
                              <yt-dynamic-sizing-formatted-string
                                class="dynamic-title-short style-scope ytd-banner-promo-renderer"
                                max-font-size="64"
                                max-height="94"
                                max-lines="2"
                                max-width="440"
                                ...
                                <div
                                  id="container"
                                  class="dynamic-text-container style-scope yt-dynamic-sizing-formatted-string"
                                  style="max-width: 440px; max-height: 94px"
                                >
                                  <yt-formatted-string
                                    id="text"
                                    disable-attributed-string=""
                                    class="style-scope yt-dynamic-sizing-formatted-string"
                                    is-empty=""
                              ...
                              <yt-dynamic-sizing-formatted-string
                                class="dynamic-title-long style-scope ytd-banner-promo-renderer"
                                max-font-size="64"
                                max-height="94"
                                max-lines="2"
                                max-width="440"
                                ...
                                >
                                  <yt-formatted-string
                                    ...
                                    class="style-scope yt-dynamic-sizing-formatted-string"
                                    style="font-weight: 700"
                                    >Get more from your favorite creators by purchasing a channel
                                    membership</yt-formatted-string
                                  >
                                </div>
                              </yt-dynamic-sizing-formatted-string>
                            </div>
                            <ytd-button-renderer
                              ...
                              ><!--css-build:shady--><yt-button-shape
                                ><a
                                  class="yt-spec-button-shape-next yt-spec-button-shape-next--outline yt-spec-button-shape-next--mono yt-spec-button-shape-next--size-m"
                                  aria-label="Browse memberships"
                                  href="/channel_memberships"
                                  rel="nofollow"
                                  target=""
                                  force-new-state="true"
                                  style="color: rgb(19, 19, 19); border-color: rgb(19, 19, 19)"
                                >
                                  <div class="cbox yt-spec-button-shape-next__button-text-content">
                                    <span
                                      class="yt-core-attributed-string yt-core-attributed-string--white-space-no-wrap"
                                      role="text"
                                      >Browse memberships</span
                                    >
                                  </div>
                                  <yt-touch-feedback-shape style="border-radius: inherit">
                                    <div
                                  ...
                                  </yt-touch-feedback-shape> </a></yt-button-shape
                              ><tp-yt-paper-tooltip
                                fit-to-visible-bounds=""
                                offset="8"
                                disable-upgrade=""
                            ...
                            <div id="dismissible" class="style-scope ytd-rich-grid-media">
                              <div id="thumbnail" class="style-scope ytd-rich-grid-media">
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        src="https://i.ytimg.com/vi/XtEeTZr_NIk/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLBGypi-2baqBih1fDOwHLxIac_rFw"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="14 minutes, 14 seconds"
                                        >
                                          14:14
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                        class="style-scope ytd-thumbnail"
                                        ><!--css-build:shady--><!--css-build:shady--><span
                                          id="overlay-text"
                                        ...
                                        <ytd-thumbnail-overlay-equalizer
                                          class="style-scope ytd-thumbnail-overlay-now-playing-renderer"
                                          ><!--css-build:shady--><!--css-build:shady--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            id="equalizer"
                                            viewBox="0 0 55 95"
                                ...
                                ><ytd-playlist-thumbnail
                                  ...
                                  size="large"
                                  hidden=""
                                  ><!--css-build:shady--><!--css-build:shady--><yt-collections-stack
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/ytc/AOPolaSLLWra5KIwA4xVQdVf8JN1BsUpoKSXN0JIb6AvQQ=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    ...
                                    ><a
                                      ...
                                      aria-label="Phân tích TOMMY SHELBY dưới góc nhìn TÂM LÝ HỌC by Phê Phim 3 hours ago 14 minutes, 14 seconds 20,591 views"
                                      title="Phân tích TOMMY SHELBY dưới góc nhìn TÂM LÝ HỌC"
                                      href="/watch?v=XtEeTZr_NIk"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label="Phân tích TOMMY SHELBY dưới góc nhìn TÂM LÝ HỌC by Phê Phim 3 hours ago 14 minutes, 14 seconds 20,591 views"
                                        >Phân tích TOMMY SHELBY dưới góc nhìn TÂM LÝ
                                        HỌC</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                    class="grid style-scope ytd-rich-grid-media"
                                    rich-meta=""
                                    amsterdam-post-mvp=""
                                    ><!--css-build:shady--><!--css-build:shady-->
                                    <div id="metadata" class="style-scope ytd-video-meta-block">
                                      ...
                                      >
                                        <ytd-channel-name
                                          ...
                                          <ytd-badge-supported-renderer
                                            ...
                                            <div
                                              role="status"
                                              class="badge badge-style-type-verified style-scope ytd-badge-supported-renderer style-scope ytd-badge-supported-renderer"
                                              aria-label="Verified"
                                            >
                                              <yt-icon
                                                size="16"
                                      ...
                                      >
                                        <ytd-badge-supported-renderer
                                          ...
                                          hidden=""
                                          system-icons=""
                                          ><!--css-build:shady--><!--css-build:shady--><dom-repeat
                                            id="repeat"
                                            as="badge"
                                            class="style-scope ytd-badge-supported-renderer"
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill yt-core-image--loaded"
                                        src="https://i.ytimg.com/vi/giPEgncCcv8/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLDjKKPRWt2G0ISAbLjedhTBI2u10Q"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="9 minutes, 25 seconds"
                                        >
                                          9:25
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/gFAnLkE0EJGMrGVvaIl-iKvOJzNXni6SFAD02mQNutWMvHWlXrHm3_ZXTqnlTbTRMUUSgg0QAg=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    <ytd-badge-supported-renderer
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      aria-label="VEERAPPAN - Gã TỘI PHẠM khiến cả ẤN ĐỘ KHIẾP SỢ by PKD 1 hour ago 9 minutes, 25 seconds 5,323 views"
                                      title="VEERAPPAN - Gã TỘI PHẠM khiến cả ẤN ĐỘ KHIẾP SỢ"
                                      href="/watch?v=giPEgncCcv8"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label="VEERAPPAN - Gã TỘI PHẠM khiến cả ẤN ĐỘ KHIẾP SỢ by PKD 1 hour ago 9 minutes, 25 seconds 5,323 views"
                                        >VEERAPPAN - Gã TỘI PHẠM khiến cả ẤN ĐỘ KHIẾP
                                        SỢ</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill yt-core-image--loaded"
                                        src="https://i.ytimg.com/vi/hCt6yjfxLMw/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLDXBZ3ArZEAkvA-KSFa5e7zwdglEQ"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="1 hour, 6 minutes, 40 seconds"
                                        >
                                          1:06:40
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/4GiYH00sOdLlEauzgiV2gepP_zb8g5XsAblLNSm96XHLmBxYXU90zGU8ARElCRzQBZ6h1Y9j=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    <ytd-badge-supported-renderer
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      aria-label="If you can’t love me, I’ll make you miss me / fall In love playlist by Fall IN Luv 1 hour ago 1 hour, 6 minutes 210 views"
                                      title="If you can’t love me, I’ll make you miss me / fall In love playlist"
                                      href="/watch?v=hCt6yjfxLMw"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label="If you can’t love me, I’ll make you miss me / fall In love playlist by Fall IN Luv 1 hour ago 1 hour, 6 minutes 210 views"
                                        >If you can’t love me, I’ll make you miss me / fall In love
                                        playlist</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill yt-core-image--loaded"
                                        src="https://i.ytimg.com/vi/nE2_6u6NyMQ/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLCLCVkkDvI6ZawEcsNDTu1u47hphQ"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="1 hour, 3 minutes, 17 seconds"
                                        >
                                          1:03:17
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/ytc/AOPolaTz3Fq8HI3kPBrBzOE63mxmz9cKodmn0UEsW0M5=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    <ytd-badge-supported-renderer
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      aria-label="Anh phải làm gì để em đừng nghĩ em không quan trọng - Như Anh Đã Thấy Em   Nhạc Lofi Chill Nhẹ Nhàng by Pii Music 6 hours ago 1 hour, 3 minutes 524 views"
                                      title="Anh phải làm gì để em đừng nghĩ em không quan trọng - Như Anh Đã Thấy Em   Nhạc Lofi Chill Nhẹ Nhàng"
                                      href="/watch?v=nE2_6u6NyMQ"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label="Anh phải làm gì để em đừng nghĩ em không quan trọng - Như Anh Đã Thấy Em   Nhạc Lofi Chill Nhẹ Nhàng by Pii Music 6 hours ago 1 hour, 3 minutes 524 views"
                                        >Anh phải làm gì để em đừng nghĩ em không quan trọng - Như
                                        Anh Đã Thấy Em Nhạc Lofi Chill Nhẹ
                                        Nhàng</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill yt-core-image--loaded"
                                        src="https://i.ytimg.com/vi/ayUYK4T1r5E/hq720.jpg?sqp=-oaymwE2CNAFEJQDSFXyq4qpAygIARUAAIhCGAFwAcABBvABAfgB_gmAAtAFigIMCAAQARhyIFcoPTAP&amp;rs=AOn4CLDz7CYk9SV4jz9vVVK_U2KeWJCCOg"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="8 hours, 1 minute, 24 seconds"
                                        >
                                          8:01:24
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/3VfvQ-86eN151pyh2y-g44dOlO7_B8cPul6o65gvkF_bd5dLjTUGdNRFtWFahBS9ADtakog=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    <ytd-badge-supported-renderer
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      aria-label='Nhạc Dí DEADLINE | Thấy nước đến cổ, hãy bật nhạc này lên và "nhảy" ^^ by Bapday 6 days ago 8 hours, 1 minute 27,171 views'
                                      title='Nhạc Dí DEADLINE | Thấy nước đến cổ, hãy bật nhạc này lên và "nhảy" ^^'
                                      href="/watch?v=ayUYK4T1r5E"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label='Nhạc Dí DEADLINE | Thấy nước đến cổ, hãy bật nhạc này lên và "nhảy" ^^ by Bapday 6 days ago 8 hours, 1 minute 27,171 views'
                                        >Nhạc Dí DEADLINE | Thấy nước đến cổ, hãy bật nhạc này lên
                                        và "nhảy" ^^</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill yt-core-image--loaded"
                                        src="https://i.ytimg.com/vi/-WSw1WW9Kmw/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLAOQT8yYvaExAHu0Xm3z4FXcmgkqw"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="11 minutes, 15 seconds"
                                        >
                                          11:15
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/-TvGkXlYr4SfJFt3DxakPZKbbaFAeT24h1jDMu-6NrvRLz8xglJLf3-zirJ0oBh5N6ndEZphNw=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    <ytd-badge-supported-renderer
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      aria-label="POKEMON HỆ ĐẤT GEN 9 CÓ GÌ MỚI? | Cơn địa chấn trên lãnh thổ Paldea | Pokemon Việt Nam | JABARKAS by Jabarkas 2 hours ago 11 minutes, 15 seconds 7,610 views"
                                      title="POKEMON HỆ ĐẤT GEN 9 CÓ GÌ MỚI? | Cơn địa chấn trên lãnh thổ Paldea | Pokemon Việt Nam | JABARKAS"
                                      href="/watch?v=-WSw1WW9Kmw"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label="POKEMON HỆ ĐẤT GEN 9 CÓ GÌ MỚI? | Cơn địa chấn trên lãnh thổ Paldea | Pokemon Việt Nam | JABARKAS by Jabarkas 2 hours ago 11 minutes, 15 seconds 7,610 views"
                                        >POKEMON HỆ ĐẤT GEN 9 CÓ GÌ MỚI? | Cơn địa chấn trên lãnh
                                        thổ Paldea | Pokemon Việt Nam |
                                        JABARKAS</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill yt-core-image--loaded"
                                        src="https://i.ytimg.com/vi/MRY1rfrGat4/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLClmMhTgekZ4UgbjhQEiP02obtIQg"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="36 minutes, 46 seconds"
                                        >
                                          36:46
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/G5AYnCYm40VpnXeTFHafqJcThLgwWjoM98I7IFBkoJaFm3ObhvLCilemOquYh7nDtmB9p3TLayQ=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    <ytd-badge-supported-renderer
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      aria-label="Toàn Bộ Secret Invasion &amp; Dự Đoán Tương Lai Của MCU by W2W Movie 1 day ago 36 minutes 20,901 views"
                                      title="Toàn Bộ Secret Invasion &amp; Dự Đoán Tương Lai Của MCU"
                                      href="/watch?v=MRY1rfrGat4"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label="Toàn Bộ Secret Invasion &amp; Dự Đoán Tương Lai Của MCU by W2W Movie 1 day ago 36 minutes 20,901 views"
                                        >Toàn Bộ Secret Invasion &amp; Dự Đoán Tương Lai Của
                                        MCU</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                  ...
                                  >
                                    <yt-image
                                      ...
                                      ><img
                                        ...
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill yt-core-image--loaded"
                                        src="https://i.ytimg.com/vi/K_Q-kQieGQ0/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLBYsJ778XXfPNTimPLL5gWO4fmewg"
                                    /></yt-image>
                                    ...
                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-time-status-renderer
                                        ...
                                        ><span
                                          id="text"
                                          class="style-scope ytd-thumbnail-overlay-time-status-renderer"
                                          aria-label="53 minutes, 47 seconds"
                                        >
                                          53:47
                                        </span></ytd-thumbnail-overlay-time-status-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                ...
                                <a
                                  ...
                                  ><yt-img-shadow
                                    ...
                                    ><!--css-build:shady--><!--css-build:shady--><img
                                      ...
                                      alt=""
                                      width="48"
                                      src="https://yt3.ggpht.com/tC69tLbQl6978xsrkLHFJxdvKDcrykP79RDbap6EyeqeCrhdTm2RC_omDGTD4qEDd6_zVGZEUw=s68-c-k-c0x00ffffff-no-rj" /></yt-img-shadow
                                ></a>
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    <ytd-badge-supported-renderer
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      title="Đồ Hàn 200k vs. Đồ Hàn 3000k | Hợp Ví"
                                      href="/watch?v=K_Q-kQieGQ0"
                                      aria-label="Đồ Hàn 200k vs. Đồ Hàn 3000k | Hợp Ví by Hay Phết 1 day ago 53 minutes 107,086 views"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        aria-label="Đồ Hàn 200k vs. Đồ Hàn 3000k | Hợp Ví by Hay Phết 1 day ago 53 minutes 107,086 views"
                                        >Đồ Hàn 200k vs. Đồ Hàn 3000k | Hợp Ví</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                              ...
                              <div id="thumbnail" class="style-scope ytd-rich-grid-media">
                                <ytd-thumbnail
                                  ...
                                  ><!--css-build:shady--><!--css-build:shady--><a
                                    ...
                                    tabindex="-1"
                                    rel="null"
                                    href="/watch?v=ADABGj-LsnE&amp;list=RDADABGj-LsnE&amp;start_radio=1"
                                  >
                                    <yt-image
                                      alt=""
                                      ftl-eligible=""
                                      ...
                                      ><img
                                        alt=""
                                        style="background-color: transparent"
                                        class="yt-core-image--fill-parent-height yt-core-image--fill-parent-width yt-core-image yt-core-image--content-mode-scale-aspect-fill"
                                    /></yt-image>

                                    <div id="overlays" class="style-scope ytd-thumbnail">
                                      <ytd-thumbnail-overlay-bottom-panel-renderer
                                        class="style-scope ytd-thumbnail"
                                        style="background-color: rgba(101, 79, 56, 0.8)"
                                        ><!--css-build:shady--><!--css-build:shady--><yt-icon
                                          class="style-scope ytd-thumbnail-overlay-bottom-panel-renderer"
                                          ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                                            class="style-scope yt-icon"
                                            ><icon-shape class="yt-spec-icon-shape">
                                              <div
                                        ...
                                        <yt-formatted-string
                                          ...
                                          ><!--css-build:shady--><!--css-build:shady--><yt-attributed-string
                                            class="style-scope yt-formatted-string"
                                          ></yt-attributed-string
                                        ></yt-formatted-string> </ytd-thumbnail-overlay-bottom-panel-renderer
                                      ><ytd-thumbnail-overlay-now-playing-renderer
                                        class="style-scope ytd-thumbnail"
                                        ><!--css-build:shady--><!--css-build:shady--><span
                                          id="overlay-text"
                                ...
                                ><ytd-playlist-thumbnail
                                  ...
                                  >
                                    ...
                                    <div id="overlays" class="style-scope ytd-playlist-thumbnail">
                                      <ytd-thumbnail-overlay-bottom-panel-renderer
                                        class="style-scope ytd-playlist-thumbnail"
                                        style="background-color: rgba(89, 88, 71, 0.8)"
                                        ><!--css-build:shady--><!--css-build:shady--><yt-icon
                                          class="style-scope ytd-thumbnail-overlay-bottom-panel-renderer"
                                          ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                                            class="style-scope yt-icon"
                                ...
                                <div id="meta" class="style-scope ytd-rich-grid-media">
                                  <h3 class="style-scope ytd-rich-grid-media">
                                    ...
                                    ><a
                                      id="video-title-link"
                                      class="yt-simple-endpoint focus-on-expand style-scope ytd-rich-grid-media"
                                      title="Mix - MÙI TỔ ẤM | QUÂN A.P x HỨA KIM TUYỀN | OFFICIAL MV"
                                      href="/watch?v=ADABGj-LsnE&amp;list=RDADABGj-LsnE&amp;start_radio=1"
                                      ><yt-formatted-string
                                        id="video-title"
                                        class="style-scope ytd-rich-grid-media"
                                        >Mix - MÙI TỔ ẤM | QUÂN A.P x HỨA KIM TUYỀN | OFFICIAL
                                        MV</yt-formatted-string
                                      ></a
                                    >
                                  </h3>
                                  <ytd-video-meta-block
                                    ...
                                    <div id="metadata" class="style-scope ytd-video-meta-block">
                                      ...
                                      >
                                        <ytd-channel-name
                                          id="channel-name"
                                          class="long-byline style-scope ytd-video-meta-block style-scope ytd-video-meta-block"
                                          ><!--css-build:shady--><!--css-build:shady-->
                                          <div id="container" class="style-scope ytd-channel-name">
                                            <div
                                              id="text-container"
                                            ...
                                            >
                                              <yt-formatted-string
                                                ...
                                                link-inherit-color=""
                                                class="style-scope ytd-channel-name"
                                                >Hua Kim Tuyen, QUÂN A.P, Song Luan, and
                                            ...
                                            <tp-yt-paper-tooltip
                                              ...
                                              <div
                                                ...
                                                style-target="tooltip"
                                              >
                                                Hua Kim Tuyen, QUÂN A.P, Song Luan, and more
                                              </div>
                                            </tp-yt-paper-tooltip>
                                          </div>
                                          <ytd-badge-supported-renderer
                      ...
                      <ytd-ghost-grid-renderer
                        ...
                        <div class="ghost-grid style-scope ytd-ghost-grid-renderer">
                          <div class="ghost-card style-scope ytd-ghost-grid-renderer">
                            <div
                              class="rich-thumbnail skeleton-bg-color style-scope ytd-ghost-grid-renderer"
                            ></div>
                            <div class="details style-scope ytd-ghost-grid-renderer">
                              <div
                                class="channel-avatar skeleton-bg-color style-scope ytd-ghost-grid-renderer"
                              ></div>
                              <div class="details-text-shell style-scope ytd-ghost-grid-renderer">
                                <div
                                  class="rich-video-title text-shell skeleton-bg-color style-scope ytd-ghost-grid-renderer"
                                ></div>
                                <div
                                  class="video-meta rich-video-meta text-shell skeleton-bg-color style-scope ytd-ghost-grid-renderer"
                                ></div>
                              </div>
                            </div>
                          </div>
              ...
              ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                ...
                ><icon-shape class="yt-spec-icon-shape">
                  <div style="width: 100%; height: 100%; fill: currentcolor">
                    ...
                    >
                      <path
                        d="M13 9v2h7V4h-2v2.74C16.53 5.07 14.4 4 12 4c-2.21 0-4.21.9-5.66 2.34S4 9.79 4 12c0 4.42 3.58 8 8 8 2.21 0 4.21-.9 5.66-2.34l-1.42-1.42C15.15 17.33 13.65 18 12 18c-3.31 0-6-2.69-6-6 0-1.65.67-3.15 1.76-4.24C8.85 6.67 10.35 6 12 6c2.21 0 4.15 1.21 5.19 3H13z"
                      ></path>
                    </svg>
                  </div> </icon-shape></yt-icon-shape
            ></yt-icon>
            <tp-yt-paper-spinner-lite class="style-scope ytd-refresh" hidden="" aria-hidden="true"
              ><!--css-build:shady-->
              <div id="spinnerContainer" class="style-scope tp-yt-paper-spinner-lite">
                <div class="spinner-layer style-scope tp-yt-paper-spinner-lite">
                  <div class="circle-clipper left style-scope tp-yt-paper-spinner-lite">
        ...
        ><ytd-watch-flexy
          ...
          ></iron-media-query>
          <iron-media-query
            id="small-window-query"
            class="style-scope ytd-watch-flexy"
            style="display: none"
          >
          </iron-media-query>
          <iron-media-query
            id="large-window-query"
            class="style-scope ytd-watch-flexy"
            style="display: none"
          >
          </iron-media-query>
          ...
          <div id="player-wide-container" class="style-scope ytd-watch-flexy">
            <div id="cinematics-wide-container" class="style-scope ytd-watch-flexy"></div>
          </div>

          <div id="single-column-container" class="style-scope ytd-watch-flexy"></div>
            ...
            <div id="primary" class="style-scope ytd-watch-flexy">
              <div id="primary-inner" class="style-scope ytd-watch-flexy">
                  ...
                  <div id="player-container-outer" class="style-scope ytd-watch-flexy">
                    <div id="player-container-inner" class="style-scope ytd-watch-flexy">
                      ...
                      >
                        <ytd-player
                          id="ytd-player"
                          context="WEB_PLAYER_CONTEXT_CONFIG_ID_KEVLAR_WATCH"
                          class="style-scope ytd-watch-flexy"
                          style="touch-action: pan-down"
                          ><!--css-build:shady--><!--css-build:shady-->
                          <div id="container" class="style-scope ytd-player">
                            <div
                              class="html5-video-player ytp-transparent ytp-exp-bottom-control-flexbox ytp-exp-ppp-update unstarted-mode ytp-hide-controls ytp-hide-info-bar ytp-small-mode ytp-tiny-mode"
                              tabindex="-1"
                              id="movie_player"
                              data-version="/s/player/f98908d1/player_ias.vflset/en_US/base.js"
                            ...
                            >
                              ...
                              <div class="ytp-chrome-top" data-layer="1">
                                <button
                                  class="ytp-playlist-menu-button ytp-button ytp-playlist-menu-button-tiny"
                                  aria-owns="ytp-id-23"
                                  aria-haspopup="true"
                                  aria-label="Playlist"
                                  style="display: none"
                              ...
                              <div
                                class="ytp-ad-persistent-progress-bar-container"
                                data-layer="4"
                                style="display: none"
                              >
                              ...
                              <div class="ytp-suggested-action" data-layer="4">
                                <button
                                  class="ytp-button ytp-suggested-action-badge ytp-suggested-action-badge-with-controls ytp-featured-product"
                                  style="display: none"
                                >
                                  ...
                                  >
                                    ...
                                    ><a class="ytp-featured-product-container" target="_blank">
                                      ...
                                      <div class="ytp-featured-product-details">
                                        ...
                                        ><text
                                          class="ytp-featured-product-countdown"
                                          style="display: none"
                                        ></text
                                        ><text class="ytp-featured-product-vendor"></text
                                        ><text class="ytp-featured-product-price"></text>
                                      </div>
                                      <button
                              ...
                              <div class="ytp-suggested-action" data-layer="4">
                                <button
                                  class="ytp-button ytp-suggested-action-badge ytp-suggested-action-badge-with-controls"
                                  style="display: none"
                                >
                                  <div class="ytp-suggested-action-badge-icon-container"></div>
                                  <div
                                ...
                                <div class="ytp-remote-display-status">
                                  <div class="ytp-remote-display-status-icon">
                                    <svg
                                      ...
                                      width="100%"
                                    >
                                      <use class="ytp-svg-shadow" xlink:href="#ytp-id-34"></use>
                                      <path
                              ...
                              >
                                <div class="ytp-mdx-popup-dialog-inner-content">
                                  ...
                                  <div class="ytp-mdx-popup-description">
                                    ...
                                    influence TV recommendations. To avoid this, cancel and sign in
                              ...
                              <div
                                class="ytp-miniplayer-ui"
                                data-layer="4"
                                style="display: none"
                              ></div>
                              <div
                                class="ytp-multicam-menu"
                                role="dialog"
                                data-layer="5"
                                style="display: none"
                              >
                                <div class="ytp-multicam-menu-header">
                                  <div class="ytp-multicam-menu-title">
                                    Switch camera<button
                                      class="ytp-multicam-menu-close ytp-button"
                                      aria-label="Close"
                                    >
                              ...
                              <div
                                ...
                                id="ytp-id-26"
                                role="dialog"
                                aria-labelledby="ytp-id-25"
                                data-layer="5"
                                style="display: none"
                              >
                                <div class="ytp-share-panel-inner-content">
                                  <div class="ytp-share-panel-title" id="ytp-id-25">Share</div>
                                  <a
                                  ...
                                  <div class="ytp-share-panel-error">
                                    An error occurred while retrieving sharing information. Please
                                    try again later.
                                  </div>
                                </div>
                                <button
                                  class="ytp-share-panel-close ytp-button"
                                  title="Close"
                                  aria-label="Close"
                                >
                                  <svg height="100%" viewBox="0 0 24 24" width="100%">
                              ...
                              >
                                <div class="ytp-overflow-panel-content">
                                  <div class="ytp-overflow-panel-action-buttons">
                                    ...
                                    ><button
                                      class="ytp-button ytp-share-button"
                                      title="Share"
                                      aria-haspopup="true"
                                      aria-owns="ytp-id-26"
                                      data-tooltip-opaque="false"
                              ...
                              <div
                                ...
                                style="
                                  height: 49px;
                                  background-image: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAxCAYAAAAbb8MkAAAAAXNSR0IArs4c6QAAAG9JREFUGFdNx1EGwgAAgOE9doNusCN0g14zZiKTmIkkIxlJIhmTRDKSjCTSIfO99T98/EHwX8d0EaKHPgaIECPBECOkGGOCDDmmmGGOBQossUKJNTbYYoc9DqhQ44gTzrjgigY33PFAiydeeOOD7w/a/BVDZcQykwAAAABJRU5ErkJggg==');
                                  display: none;
                                "
                              ></div>
                              <div
                                ...
                                data-layer="9"
                                style="display: none; width: 100px; left: 12px"
                              >
                                <div class="ytp-progress-bar-container" aria-disabled="true">
                                  ...
                                  <div
                                    ...
                                    aria-valuemax="0"
                                    aria-valuenow="0"
                                    aria-valuetext="0 Minutes 0 Seconds of 0 Minutes 0 Seconds"
                                  >
                                    <div class="ytp-chapters-container">
                                      <div class="ytp-chapter-hover-container" style="width: 100%">
                                  ...
                                  <div class="ytp-fine-scrubbing-container">
                                    ...
                                    <div class="ytp-fine-scrubbing">
                                      <div
                                        ...
                                        draggable="true"
                                        style="touch-action: none; padding: 0px"
                                      >
                                        <div
                                      ...
                                      <div
                                        class="ytp-fine-scrubbing-cursor"
                                        aria-hidden="true"
                                      ></div>
                                      ...
                                      <div
                                        ...
                                        role="button"
                                        aria-label="Play from this position"
                                      >
                                        <svg
                                          height="100%"
                                          version="1.1"
                                      ...
                                      <div
                                        ...
                                        role="button"
                                        aria-label="Exit precise seeking"
                                      >
                                        <svg height="100%" viewBox="0 0 24 24" width="100%">
                                          <path
                                            d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"
                                ...
                                <div class="ytp-chrome-controls">
                                  <div class="ytp-left-controls">
                                    ...
                                    ><span class="ytp-volume-area"
                                      ...
                                      >
                                        ...
                                        >
                                          <div
                                            class="ytp-volume-slider-handle"
                                            style="left: 40px"
                                          ></div>
                                        </div>
                                      </div>
                                    </span>
                                    <div class="ytp-time-display notranslate" style="display: none">
                                      <span class="ytp-time-clip-icon"
                                        ...
                                        >
                                          ...
                                          ></path></svg></span
                                      ><span
                                        ><span class="ytp-time-current"></span
                                        ><span class="ytp-time-separator"> / </span
                                        ><span class="ytp-time-duration"></span></span
                                  ...
                                  <div class="ytp-right-controls">
                                    <button
                                      ...
                                      style="display: none"
                                    >
                                      <div class="ytp-fullerscreen-edu-text">
                                        Scroll for details
                                      </div>
                                    ...
                                    >
                                      <div class="ytp-autonav-toggle-button-container">
                                        <div
                                          class="ytp-autonav-toggle-button"
                                          aria-checked="true"
                                        ></div>
                                      </div></button
                                    ><button
                                      ...
                                      aria-keyshortcuts="c"
                                      data-priority="3"
                                      title="Subtitles/closed captions unavailable"
                                      data-title-no-tooltip="Subtitles/closed captions unavailable"
                                      aria-pressed="false"
                                    ...
                                    ><button
                                      class="ytp-multicam-button ytp-button"
                                      title="Switch camera"
                                      aria-haspopup="true"
                                      data-priority="4"
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <path
                                          d="M 26,10 22.83,10 21,8 15,8 13.17,10 10,10 c -1.1,0 -2,.9 -2,2 l 0,12 c 0,1.1 .9,2 2,2 l 16,0 c 1.1,0 2,-0.9 2,-2 l 0,-12 c 0,-1.1 -0.9,-2 -2,-2 l 0,0 z m -5,11.5 0,-2.5 -6,0 0,2.5 -3.5,-3.5 3.5,-3.5 0,2.5 6,0 0,-2.5 3.5,3.5 -3.5,3.5 0,0 z"
                                          fill="#fff"
                                          id="ytp-id-20"
                                        ></path>
                                      </svg></button
                ...
                <div id="below" class="style-scope ytd-watch-flexy">
                  ...
                  <div
                    id="limited-state"
                    class="attached-message style-scope ytd-watch-flexy"
                  ></div>
                  <ytd-watch-metadata
                    is-watch-flexy=""
                    class="watch-active-metadata style-scope ytd-watch-flexy style-scope ytd-watch-flexy"
                      ...
                      <div id="top-row" class="style-scope ytd-watch-metadata">
                        <div id="owner" class="item style-scope ytd-watch-metadata">
                          <ytd-video-owner-renderer
                            ...
                            class="style-scope ytd-watch-metadata"
                            ><!--css-build:shady--><!--css-build:shady--><a
                              class="yt-simple-endpoint style-scope ytd-video-owner-renderer"
                              tabindex="-1"
                              ><yt-img-shadow
                                id="avatar"
                                width="40"
                                class="style-scope ytd-video-owner-renderer no-transition"
                                ><!--css-build:shady--><!--css-build:shady--><img
                                  id="img"
                                  draggable="false"
                                  class="style-scope yt-img-shadow"
                                  alt=""
                                  width="40" /></yt-img-shadow
                            ></a>
                            <div id="upload-info" class="style-scope ytd-video-owner-renderer">
                              <ytd-channel-name
                                id="channel-name"
                                class="style-scope ytd-video-owner-renderer"
                                ><!--css-build:shady--><!--css-build:shady-->
                                <div id="container" class="style-scope ytd-channel-name">
                      ...
                      <div id="bottom-row" class="style-scope ytd-watch-metadata">
                        <div id="description" class="item style-scope ytd-watch-metadata">
                          <div id="description-inner" class="style-scope ytd-watch-metadata">
                            ...
                            <div id="info-container" class="style-scope ytd-watch-metadata">
                              <yt-formatted-string
                                ...
                                is-empty=""
                              ></yt-formatted-string>
                              <dom-if class="style-scope ytd-watch-metadata"
                                ><template is="dom-if"></template
                              ></dom-if>
                            </div>
                            ...
                            >
                              <yt-attributed-string
                                id="attributed-description-text"
                                class="style-scope ytd-watch-metadata"
                                disable-upgrade=""
                              >
                              </yt-attributed-string>
                              ...
                              <yt-formatted-string
                                id="formatted-description-text"
                                class="style-scope ytd-watch-metadata"
                                disable-upgrade=""
                              >
                              </yt-formatted-string>
                              <ytd-structured-description-content-renderer
                                id="faded-structured-description"
                                inline-structured-description=""
                                class="style-scope ytd-watch-metadata"
                                disable-upgrade=""
                                hidden=""
                              >
                              ...
                              <tp-yt-paper-button
                                id="collapse-button"
                                class="button style-scope ytd-watch-metadata"
                                hidden=""
                                style-target="host"
                                role="button"
                                tabindex="0"
                            ...
                            <ytd-text-inline-expander
                              ...
                              >
                                ...
                                ><tp-yt-paper-button
                                  id="expand-sizer"
                                  class="button style-scope ytd-text-inline-expander"
                                  style-target="host"
                                  role="button"
                                  tabindex="0"
                                  animated=""
                          ...
                          <yt-interaction
                            ...
                            class="rounded-large style-scope ytd-watch-metadata"
                            ><!--css-build:shady--><!--css-build:shady-->
                            <div class="stroke style-scope yt-interaction"></div>
                            <div class="fill style-scope yt-interaction"></div>
                          </yt-interaction>
                        ...
                        <div
                          id="comment-teaser"
                          class="item style-scope ytd-watch-metadata"
                          hidden=""
                        ></div>
                      </div>
                    </div>

                    <ytd-metadata-row-container-renderer class="style-scope ytd-watch-metadata"
                      ><!--css-build:shady--><!--css-build:shady-->
                      <div
                        id="always-shown"
                  ...
                  <div class="style-scope ytd-watch-flexy style-scope ytd-watch-flexy">
                    <div id="info" class="style-scope ytd-watch-flexy">
                      <div id="info-skeleton" class="watch-skeleton style-scope ytd-watch-flexy">
                      ...
                      <div id="info-contents" class="style-scope ytd-watch-flexy" hidden="">
                        <ytd-video-primary-info-renderer class="style-scope ytd-watch-flexy"
                          ><!--css-build:shady--><!--css-build:shady-->
                          <div id="container" class="style-scope ytd-video-primary-info-renderer">
                            ...
                            ></ytd-badge-supported-renderer
                            ><a
                              class="yt-simple-endpoint style-scope ytd-video-primary-info-renderer"
                              hidden=""
                              ><yt-icon
                                class="super-title-icon style-scope ytd-video-primary-info-renderer"
                                icon="yt-icons:location_pin"
                                ><!--css-build:shady--><!--css-build:shady--><yt-icon-shape
                                  class="style-scope yt-icon"
                                  ><icon-shape class="yt-spec-icon-shape">
                                    <div style="width: 100%; height: 100%; fill: currentcolor">
                                    ...
                                    </div> </icon-shape></yt-icon-shape></yt-icon></a
                            ><yt-formatted-string
                              class="super-title style-scope ytd-video-primary-info-renderer"
                              force-default-style=""
                              is-empty=""
                              ><!--css-build:shady--><!--css-build:shady--><yt-attributed-string
                                class="style-scope yt-formatted-string"
                    ...
                    <div id="meta" class="style-scope ytd-watch-flexy">
                      <div id="meta-skeleton" class="watch-skeleton style-scope ytd-watch-flexy">
                  ...
                  <div id="expandable-metadata" class="style-scope ytd-watch-flexy"></div>
                  <div id="ticket-shelf" class="style-scope ytd-watch-flexy"></div>

                  <dom-if restamp="" id="merch-shelf" class="style-scope ytd-watch-flexy"
                    ><template is="dom-if"></template
                  ></dom-if>
                  <ytd-comments
                    id="comments"
              ...
              <div id="secondary-inner" class="style-scope ytd-watch-flexy">
                ...
                <ytd-playlist-panel-renderer
                  ...
                  <div id="container" class="style-scope ytd-playlist-panel-renderer">
                        ...
                        <div id="header-top-row" class="style-scope ytd-playlist-panel-renderer">
                          ...
                          >
                            ...
                            >
                              ...
                              ></yt-formatted-string>
                              <div
                                class="index-message-wrapper style-scope ytd-playlist-panel-renderer"
                              >
                                <span class="index-message style-scope ytd-playlist-panel-renderer"
                                  >NaN / NaN</span
                                ><yt-formatted-string
                    ...
                    <div
                      id="items"
                      class="playlist-items style-scope ytd-playlist-panel-renderer"
                    ></div>
                  </div>
                </ytd-playlist-panel-renderer>
                <div id="chat-container" class="style-scope ytd-watch-flexy">
                  <dom-if restamp="" id="chat-template" class="style-scope ytd-watch-flexy"
                    ><template is="dom-if"></template
                  ></dom-if>
                </div>
                ...
                <div id="related" class="style-scope ytd-watch-flexy">
                  ...
                  <div id="related-skeleton" class="watch-skeleton style-scope ytd-watch-flexy">
                    <div id="related">
    ...
    <ytd-popup-container class="style-scope ytd-app"
      ><!--css-build:shady--><!--css-build:shady--></ytd-popup-container
    >
    <ytd-third-party-manager class="style-scope ytd-app"
      ><!--css-build:shady--><!--css-build:shady--></ytd-third-party-manager
    >
    <div id="video-preview" class="style-scope ytd-app">
      <ytd-video-preview
        class="style-scope ytd-app"
        unround-corners-for-playback=""
        style="
          --ytd-video-preview-translate-left: 0px;
          --ytd-video-preview-translate-top: -0.14924142480211344px;
          --ytd-video-preview-original-top-position: 124.02424142480211px;
          --ytd-video-preview-original-horizontal-position: 645.8515625px;
          --ytd-video-preview-initial-scale: scale(0.9979798812664907);
          --ytd-video-preview-width: 379px;
          --ytd-video-preview-height: 213px;
        "
        ...
        <div id="video-preview-container" class="style-scope ytd-video-preview">
          ...
          <div id="media-container" class="style-scope ytd-video-preview">
            <a id="media-container-link" class="yt-simple-endpoint style-scope ytd-video-preview">
              <div id="player-container" class="style-scope ytd-video-preview">
                <ytd-player
                  id="inline-player"
                  context="WEB_PLAYER_CONTEXT_CONFIG_ID_KEVLAR_INLINE_PREVIEW"
                  class="style-scope ytd-video-preview"
                  style="touch-action: pan-down"
                  ><!--css-build:shady--><!--css-build:shady-->
                  <div id="container" class="style-scope ytd-player">
                    <div
                      class="html5-video-player ytp-exp-bottom-control-flexbox ytp-exp-ppp-update ytp-fit-cover-video ytp-hide-info-bar ytp-small-mode ytp-menu-shown ytp-inline-preview-mode ytp-no-contextmenu ytp-autonav-endscreen-cancelled-state ytp-show-inline-preview-audio-controls unstarted-mode ytp-hide-controls"
                      tabindex="-1"
                    ...
                    >
                      <div class="html5-video-container" data-layer="0">
                        <video
                          ...
                          controlslist="nodownload"
                          style="width: 379px; height: 213px; left: 0px; top: -213px"
                          __idm_id__="32769"
                        ></video>
                      </div>
                      <div class="ytp-gradient-top" data-layer="1" style="display: none"></div>
                      <div class="ytp-chrome-top" data-layer="1" style="display: none">
                        <button
                          class="ytp-playlist-menu-button ytp-button ytp-playlist-menu-button-tiny"
                          aria-owns="ytp-id-56"
                          aria-haspopup="true"
                        ...
                        <div class="ytp-title">
                          <div class="ytp-title-text">
                            <a
                              ...
                              data-sessionlink="feature=player-title"
                              tabindex="-1"
                              href="https://www.youtube.com/watch?v=K_Q-kQieGQ0"
                            ></a>
                            <div class="ytp-title-subtext">
                              <a class="ytp-title-channel-name" target="_blank" href=""></a>
                            </div>
                        ...
                        <div class="ytp-chrome-top-buttons">
                          ...
                          >
                            <span class="ytp-cards-button-icon-default">
                              <div class="ytp-cards-button-icon">
                                <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                  <use class="ytp-svg-shadow" xlink:href="#ytp-id-36"></use>
                                  <path
                                    class="ytp-svg-fill"
                                    d="M18,8 C12.47,8 8,12.47 8,18 C8,23.52 12.47,28 18,28 C23.52,28 28,23.52 28,18 C28,12.47 23.52,8 18,8 L18,8 Z M17,16 L19,16 L19,24 L17,24 L17,16 Z M17,12 L19,12 L19,14 L17,14 L17,12 Z"
                                    id="ytp-id-36"
                      ...
                      >
                        <div class="ytp-unmute-inner">
                          <div class="ytp-unmute-icon">
                            <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                              <use class="ytp-svg-shadow" xlink:href="#ytp-id-35"></use>
                              <path
                                class="ytp-svg-fill"
                                d="m 21.48,17.98 c 0,-1.77 -1.02,-3.29 -2.5,-4.03 v 2.21 l 2.45,2.45 c .03,-0.2 .05,-0.41 .05,-0.63 z m 2.5,0 c 0,.94 -0.2,1.82 -0.54,2.64 l 1.51,1.51 c .66,-1.24 1.03,-2.65 1.03,-4.15 0,-4.28 -2.99,-7.86 -7,-8.76 v 2.05 c 2.89,.86 5,3.54 5,6.71 z M 9.25,8.98 l -1.27,1.26 4.72,4.73 H 7.98 v 6 H 11.98 l 5,5 v -6.73 l 4.25,4.25 c -0.67,.52 -1.42,.93 -2.25,1.18 v 2.06 c 1.38,-0.31 2.63,-0.95 3.69,-1.81 l 2.04,2.05 1.27,-1.27 -9,-9 -7.72,-7.72 z m 7.72,.99 -2.09,2.08 2.09,2.09 V 9.98 z"
                                id="ytp-id-35"
                      ...
                      <div class="ytp-cued-thumbnail-overlay" data-layer="4" style="">
                        <div
                          ...
                          style="
                            background-image: url('https://i.ytimg.com/vi/K_Q-kQieGQ0/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&amp;rs=AOn4CLCumM_REfNBbHlFYr3nhYaffW2_QQ');
                          "
                        ></div>
                        <button class="ytp-large-play-button ytp-button" aria-label="Play">
                          <svg height="100%" version="1.1" viewBox="0 0 68 48" width="100%">
                      ...
                      <div
                        class="ytp-popup ytp-generic-popup"
                        role="alert"
                        tabindex="0"
                        data-layer="4"
                        style="display: none"
                      >
                        ...
                        <a href="https://support.google.com/youtube/answer/6276924" target="_blank"
                          >Learn More</a
                        >
                      </div>
                      ...
                      <div class="ytp-doubletap-ui-legacy" style="display: none" data-layer="4">
                        <div class="ytp-doubletap-fast-forward-ve"></div>
                        <div class="ytp-doubletap-rewind-ve"></div>
                        <div class="ytp-doubletap-static-circle">
                          <div class="ytp-doubletap-ripple"></div>
                      ...
                      <div aria-live="polite" style="display: none" data-layer="4">
                        <div class="ytp-tooltip-text-wrapper">
                          <div class="ytp-tooltip-edu">
                            <svg height="100%" viewBox="0 0 36 36" width="100%">
                              <path
                      ...
                      <div class="ytp-inline-preview-ui" style="" data-layer="4">
                        <div class="ytp-inline-preview-scrim">
                          <div class="ytp-time-display notranslate" style="display: none">
                            <span class="ytp-time-clip-icon"
                            ...
                            ><span
                              ...
                              ><span class="ytp-time-separator"> / </span
                              ><span class="ytp-time-duration">0:00</span></span
                            ><span class="ytp-clip-watch-full-video-button-separator">•</span
                            ><span class="ytp-clip-watch-full-video-button">Watch full video</span
                            ><button class="ytp-live-badge ytp-button" disabled="true">Live</button>
                          </div>
                        </div>
                        <div class="ytp-inline-preview-controls">
                          <button
                            class="ytp-mute-button ytp-button"
                            aria-keyshortcuts="m"
                            title="Unmute"
                            data-title-no-tooltip="Unmute"
                            style=""
                          >
                            <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                              <use class="ytp-svg-shadow" xlink:href="#ytp-id-68"></use>
                              <path
                                class="ytp-svg-fill"
                                d="m 21.48,17.98 c 0,-1.77 -1.02,-3.29 -2.5,-4.03 v 2.21 l 2.45,2.45 c .03,-0.2 .05,-0.41 .05,-0.63 z m 2.5,0 c 0,.94 -0.2,1.82 -0.54,2.64 l 1.51,1.51 c .66,-1.24 1.03,-2.65 1.03,-4.15 0,-4.28 -2.99,-7.86 -7,-8.76 v 2.05 c 2.89,.86 5,3.54 5,6.71 z M 9.25,8.98 l -1.27,1.26 4.72,4.73 H 7.98 v 6 H 11.98 l 5,5 v -6.73 l 4.25,4.25 c -0.67,.52 -1.42,.93 -2.25,1.18 v 2.06 c 1.38,-0.31 2.63,-0.95 3.69,-1.81 l 2.04,2.05 1.27,-1.27 -9,-9 -7.72,-7.72 z m 7.72,.99 -2.09,2.08 2.09,2.09 V 9.98 z"
                                id="ytp-id-68"
                          ...
                          >
                            <svg
                              ...
                              fill-opacity="0.3"
                            >
                              <use class="ytp-svg-shadow" xlink:href="#ytp-id-69"></use>
                              <path
                                d="M11,11 C9.89,11 9,11.9 9,13 L9,23 C9,24.1 9.89,25 11,25 L25,25 C26.1,25 27,24.1 27,23 L27,13 C27,11.9 26.1,11 25,11 L11,11 Z M17,17 L15.5,17 L15.5,16.5 L13.5,16.5 L13.5,19.5 L15.5,19.5 L15.5,19 L17,19 L17,20 C17,20.55 16.55,21 16,21 L13,21 C12.45,21 12,20.55 12,20 L12,16 C12,15.45 12.45,15 13,15 L16,15 C16.55,15 17,15.45 17,16 L17,17 L17,17 Z M24,17 L22.5,17 L22.5,16.5 L20.5,16.5 L20.5,19.5 L22.5,19.5 L22.5,19 L24,19 L24,20 C24,20.55 23.55,21 23,21 L20,21 C19.45,21 19,20.55 19,20 L19,16 C19,15.45 19.45,15 20,15 L23,15 C23.55,15 24,15.45 24,16 L24,17 L24,17 Z"
                                fill="#fff"
                                id="ytp-id-69"
                      ...
                      <div class="ytp-progress-bar-container" data-layer="4">
                        <div class="ytp-heat-map-container">
                          <div class="ytp-heat-map-edu"></div>
                        </div>
                        <div
                        ...
                        >
                          <svg height="100%" version="1.1" viewBox="0 0 14 14" width="100%">
                            <use class="ytp-svg-shadow" xlink:href="#ytp-id-71"></use>
                            <path
                              d="M2,14 L5,11 L5,3 L2,0 L9,0 L9,14 L2,14 L2,14 Z"
                              fill="#eaeaea"
                              id="ytp-id-71"
                      ...
                      <div
                        ...
                        id="ytp-id-59"
                        role="dialog"
                        aria-labelledby="ytp-id-58"
                        style="display: none"
                        data-layer="5"
                      >
                        <div class="ytp-share-panel-inner-content">
                          <div class="ytp-share-panel-title" id="ytp-id-58">Share</div>
                          <a
                            class="ytp-share-panel-link ytp-no-contextmenu"
                            target="_blank"
                            title="Share link"
                        ...
                        <div class="ytp-overflow-panel-content">
                          <div class="ytp-overflow-panel-action-buttons">
                            ...
                            >
                              <div class="ytp-watch-later-icon">
                                <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                  <use class="ytp-svg-shadow" xlink:href="#ytp-id-60"></use>
                                  <path
                                    class="ytp-svg-fill"
                                    d="M18,8 C12.47,8 8,12.47 8,18 C8,23.52 12.47,28 18,28 C23.52,28 28,23.52 28,18 C28,12.47 23.52,8 18,8 L18,8 Z M16,19.02 L16,12.00 L18,12.00 L18,17.86 L23.10,20.81 L22.10,22.54 L16,19.02 Z"
                                    id="ytp-id-60"
                            ...
                            >
                              <div class="ytp-share-icon">
                                <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                  <use class="ytp-svg-shadow" xlink:href="#ytp-id-415"></use>
                                  <path
                                    class="ytp-svg-fill"
                                    d="m 20.20,14.19 0,-4.45 7.79,7.79 -7.79,7.79 0,-4.56 C 16.27,20.69 12.10,21.81 9.34,24.76 8.80,25.13 7.60,27.29 8.12,25.65 9.08,21.32 11.80,17.18 15.98,15.38 c 1.33,-0.60 2.76,-0.98 4.21,-1.19 z"
                                    id="ytp-id-415"
                            ...
                            >
                              <div class="ytp-copylink-icon">
                                <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                  <use class="ytp-svg-shadow" xlink:href="#ytp-id-416"></use>
                                  <path
                                    class="ytp-svg-fill"
                                    d="M21.9,8.3H11.3c-0.9,0-1.7,.8-1.7,1.7v12.3h1.7V10h10.6V8.3z M24.6,11.8h-9.7c-1,0-1.8,.8-1.8,1.8v12.3  c0,1,.8,1.8,1.8,1.8h9.7c1,0,1.8-0.8,1.8-1.8V13.5C26.3,12.6,25.5,11.8,24.6,11.8z M24.6,25.9h-9.7V13.5h9.7V25.9z"
                                    id="ytp-id-416"
                      ...
                      <div
                        ...
                        style="
                          height: 87px;
                          background-image: url('data:image/png;base64,');
                          display: none;
                        "
                      ></div>
                      <div
                        class="ytp-chrome-bottom"
                        data-layer="9"
                        style="width: 355px; left: 12px; display: none"
                      >
                        <div class="ytp-progress-bar-container">
                          ...
                          <div class="ytp-fine-scrubbing-container">
                            <div class="ytp-fine-scrubbing-edu"></div>
                            <div class="ytp-fine-scrubbing" style="display: none">
                              <div
                                class="ytp-fine-scrubbing-draggable"
                                draggable="true"
                                style="touch-action: none; padding: 0px 177.5px"
                              >
                                <div
                                  class="ytp-fine-scrubbing-thumbnails"
                                  tabindex="0"
                              ...
                              >
                                <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                  <use class="ytp-svg-shadow" xlink:href="#ytp-id-39"></use>
                                  <path
                                    class="ytp-svg-fill"
                                    d="M 12,26 18.5,22 18.5,14 12,10 z M 18.5,22 25,18 25,18 18.5,14 z"
                                    id="ytp-id-39"
                        ...
                        <div class="ytp-chrome-controls">
                          <div class="ytp-left-controls">
                            ...
                            >
                              <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                <use class="ytp-svg-shadow" xlink:href="#ytp-id-380"></use>
                                <path
                                  class="ytp-svg-fill"
                                  d="M 12,26 18.5,22 18.5,14 12,10 z M 18.5,22 25,18 25,18 18.5,14 z"
                                  id="ytp-id-380"
                            ...
                            ><a
                              ...
                              aria-label="Next"
                              ><svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                <use class="ytp-svg-shadow" xlink:href="#ytp-id-47"></use>
                                <path
                                  class="ytp-svg-fill"
                                  d="M 12,24 20.5,18 12,12 V 24 z M 22,12 v 12 h 2 V 12 h -2 z"
                                  id="ytp-id-47"
                            ...
                            ><span class="ytp-volume-area"
                              ...
                              >
                                <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                  <use class="ytp-svg-shadow" xlink:href="#ytp-id-51"></use>
                                  <path
                                    class="ytp-svg-fill"
                                    d="m 21.48,17.98 c 0,-1.77 -1.02,-3.29 -2.5,-4.03 v 2.21 l 2.45,2.45 c .03,-0.2 .05,-0.41 .05,-0.63 z m 2.5,0 c 0,.94 -0.2,1.82 -0.54,2.64 l 1.51,1.51 c .66,-1.24 1.03,-2.65 1.03,-4.15 0,-4.28 -2.99,-7.86 -7,-8.76 v 2.05 c 2.89,.86 5,3.54 5,6.71 z M 9.25,8.98 l -1.27,1.26 4.72,4.73 H 7.98 v 6 H 11.98 l 5,5 v -6.73 l 4.25,4.25 c -0.67,.52 -1.42,.93 -2.25,1.18 v 2.06 c 1.38,-0.31 2.63,-0.95 3.69,-1.81 l 2.04,2.05 1.27,-1.27 -9,-9 -7.72,-7.72 z m 7.72,.99 -2.09,2.08 2.09,2.09 V 9.98 z"
                                    id="ytp-id-51"
                              ...
                              <div
                                ...
                                tabindex="0"
                                aria-valuenow="100"
                                aria-valuetext="100% volume muted"
                                aria-label="Volume"
                                style=""
                              >
                                <div
                                  ...
                                  style="touch-action: none"
                                >
                                  <div class="ytp-volume-slider-handle" style="left: 0px"></div>
                                </div>
                              </div>
                            </span>
                            <div
                              class="ytp-time-display notranslate ytp-time-display-allow-autohide"
                              style=""
                            >
                              <span class="ytp-time-clip-icon"
                                ><svg height="100%" version="1.1" viewBox="0 0 24 24" width="100%">
                          ...
                          <div class="ytp-right-controls">
                            ...
                            >
                              <svg
                                ...
                                fill-opacity="0.3"
                              >
                                <use class="ytp-svg-shadow" xlink:href="#ytp-id-52"></use>
                                <path
                                  d="M11,11 C9.89,11 9,11.9 9,13 L9,23 C9,24.1 9.89,25 11,25 L25,25 C26.1,25 27,24.1 27,23 L27,13 C27,11.9 26.1,11 25,11 L11,11 Z M17,17 L15.5,17 L15.5,16.5 L13.5,16.5 L13.5,19.5 L15.5,19.5 L15.5,19 L17,19 L17,20 C17,20.55 16.55,21 16,21 L13,21 C12.45,21 12,20.55 12,20 L12,16 C12,15.45 12.45,15 13,15 L16,15 C16.55,15 17,15.45 17,16 L17,17 L17,17 Z M24,17 L22.5,17 L22.5,16.5 L20.5,16.5 L20.5,19.5 L22.5,19.5 L22.5,19 L24,19 L24,20 C24,20.55 23.55,21 23,21 L20,21 C19.45,21 19,20.55 19,20 L19,16 C19,15.45 19.45,15 20,15 L23,15 C23.55,15 24,15.45 24,16 L24,17 L24,17 Z"
                                  fill="#fff"
                                  id="ytp-id-52"
                            ...
                            >
                              <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                <use class="ytp-svg-shadow" xlink:href="#ytp-id-55"></use>
                                <path
                                  d="M 26,10 22.83,10 21,8 15,8 13.17,10 10,10 c -1.1,0 -2,.9 -2,2 l 0,12 c 0,1.1 .9,2 2,2 l 16,0 c 1.1,0 2,-0.9 2,-2 l 0,-12 c 0,-1.1 -0.9,-2 -2,-2 l 0,0 z m -5,11.5 0,-2.5 -6,0 0,2.5 -3.5,-3.5 3.5,-3.5 0,2.5 6,0 0,-2.5 3.5,3.5 -3.5,3.5 0,0 z"
                                  fill="#fff"
                                  id="ytp-id-55"
                            ...
                            >
                              <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                <use class="ytp-svg-shadow" xlink:href="#ytp-id-40"></use>
                                <path
                                  d="M25,17 L17,17 L17,23 L25,23 L25,17 L25,17 Z M29,25 L29,10.98 C29,9.88 28.1,9 27,9 L9,9 C7.9,9 7,9.88 7,10.98 L7,25 C7,26.1 7.9,27 9,27 L27,27 C28.1,27 29,26.1 29,25 L29,25 Z M27,25.02 L9,25.02 L9,10.97 L27,10.97 L27,25.02 L27,25.02 Z"
                                  fill="#fff"
                                  id="ytp-id-40"
                            ...
                            >
                              <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                <use class="ytp-svg-shadow" xlink:href="#ytp-id-64"></use>
                                <path
                                  d="m 28,11 0,14 -20,0 0,-14 z m -18,2 16,0 0,10 -16,0 0,-10 z"
                                  fill="#fff"
                                  fill-rule="evenodd"
                            ...
                            >
                              <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
                                ...
                                <g class="ytp-fullscreen-button-corner-2">
                                  <use class="ytp-svg-shadow" xlink:href="#ytp-id-43"></use>
                                  <path
                                    class="ytp-svg-fill"
                                    d="m 24,24 -4,0 0,2 L 26,26 l 0,-6 -2,0 0,4 0,0 z"
                                    id="ytp-id-43"
    ...
    <yt-page-navigation-progress
      ...
      aria-valuemax="100"
      ><!--css-build:shady--><!--css-build:shady-->
      <div id="progress" class="style-scope yt-page-navigation-progress"></div>
    </yt-page-navigation-progress>
  </ytd-app>
</template>
