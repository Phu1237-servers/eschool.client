<template>
  ...
  <ytd-page-manager id="page-manager" class="style-scope ytd-app"
    ...
    >
      ...
      <ytd-channel-legal-info-renderer class="style-scope ytd-browse" disable-upgrade="" hidden="">
          ...
          >
            <div id="header" class="style-scope ytd-rich-grid-renderer">
              <ytd-feed-filter-chip-bar-renderer
                ...
                style="--ytd-rich-grid-chips-bar-width: 1609px; --ytd-rich-grid-chips-bar-top: 56px"
              >
            ...
            <div id="contents" class="style-scope ytd-rich-grid-renderer">
              <ytd-rich-grid-row class="style-scope ytd-rich-grid-renderer">
                <div id="contents" class="style-scope ytd-rich-grid-row">
                  <ytd-rich-item-renderer class="style-scope ytd-rich-grid-row" items-per-row="4">
                              ...
                              <h3 class="style-scope ytd-rich-grid-media">
                                ...
                                ><a
                                  ...
                                  ><yt-formatted-string
                                    ...
                                    class="style-scope ytd-rich-grid-media"
                                    aria-label="Anh phải làm gì để em đừng nghĩ em không quan trọng - Như Anh Đã Thấy Em   Nhạc Lofi Chill Nhẹ Nhàng by Pii Music 6 hours ago 1 hour, 3 minutes 524 views"
                                    >Anh phải làm gì để em đừng nghĩ em không quan trọng - Như Anh
                                    Đã Thấy Em Nhạc Lofi Chill Nhẹ Nhàng</yt-formatted-string
                                  ></a
                                >
                              </h3>
                              <ytd-video-meta-block
    ...
    ><ytd-watch-flexy
      ...
      is-two-columns_=""
      style="--ytd-watch-flexy-scrollbar-width: 15px; --ytd-watch-flexy-space-below-player: 136px"
      flexy-large-window_=""
    >
      <iron-media-query
        id="two-column-query"
                          ...
                          >
                            <div class="ytp-mdx-popup-dialog-inner-content">
                              ...
                              <div class="ytp-mdx-popup-description">
                                ...
                                influence TV recommendations. To avoid this, cancel and sign in to
                  ...
                  <div id="bottom-row" class="style-scope ytd-watch-metadata">
                    <div id="description" class="item style-scope ytd-watch-metadata">
                      <div id="description-inner" class="style-scope ytd-watch-metadata">
                        ...
                        <dom-if restamp="" id="product-shelf" class="style-scope ytd-watch-metadata"
                          ><template is="dom-if"></template
                        ></dom-if>
                        <yt-formatted-string
